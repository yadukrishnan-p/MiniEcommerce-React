                ...
                <div class="row d-flex justify-content-between">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4 col-lg-3 mt-4 mt-lg-0">
                                            <div class="stockCounter d-inline">
                                                <span class="btn btn-danger minus" onClick={() => dicreaseQty(item)}>-</span>
                                        ...
                                        <div class="col-4 col-lg-1 mt-4 mt-lg-0">
                                            <i id="delete_cart_item" onClick={() => removeCart(item)} class="fa fa-trash btn btn-danger"></i>
                                        </div>
                                    </div>
                                </div>
                            </Fragment>
                    ...
                    <div class="col-12 col-lg-3 my-4">
                        <div id="order_summary">
                            ...
                            <hr />
                            <button id="checkout_btn" onClick={placeholderHandler} class="btn btn-primary btn-block">Place Order</button>
                        </div>
                    </div>
                </div>
            </div>
